    ...
    return (
        <>
            ...
            <main className="page-wrapper">
                ...
                {/* Start Slider Area  */}
                <div className="slider-area slider-style-1 variation-default height-850 bg_image" data-black-overlay="7" style={{backgroundImage: `url(/images/bg/bg-image-18.jpg)`}}>
