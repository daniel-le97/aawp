    ...
    return (
        <>
            ...
            <main className="page-wrapper">
                ...
                {/* Start Slider area  */}
                <div className="slider-area slider-style-5 bg-overlay-solid height-850 bg_image" data-black-overlay="3" style={{backgroundImage: `url(/images/bg/bg-image-13.jpg)`}}>
                            ...
                            <div className="col-lg-12">
                                <div className="inner text-start">
                                    ...
                                    <div className="button-group mt--40 mt_sm--20">
                                        <a className="btn-default" target="_blank" href="https://themeforest.net/checkout/from_item/33571911?license=regular">BUY All-American Pressure Washing, LLC NOW</a>
                                    </div>
                                </div>
                            </div>
                        </div>
