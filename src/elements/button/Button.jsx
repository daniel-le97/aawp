...
const Button = () => {
    return (
        <>
            <SEO title="All-American Pressure Washing || House Sidings" />
            <Layout>
                <BreadcrumbOne 
                title="Quick and easy pressure washing to <br /> keep your house siding looking good."
                rootUrl="/"
                parentUrl="Home"
                currentUrl="House Sidings"
                />
                <div className="main-content">
                    PICTURES OR CAROUSEL OR VIDEOS OF HOUSE SIDINGS
                    {/* Start Elements Area  */}
